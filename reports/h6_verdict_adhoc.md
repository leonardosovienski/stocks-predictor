...
- **veredito H6:** **não comprovada (IC cruza 0 / negativo; DSR 0.4828 < 0.95)**
...
- **Critério (ii) — DSR (Deflated Sharpe Ratio):** 0.4828 contra E[max SR | N=5] = 0.0123 por-período (mínimo pré-registrado: 0.95)
