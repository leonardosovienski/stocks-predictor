...
def execute_rebalance(book, plan, execution_quotes, cost_rate, *, order_units_reviewed=False):
    """Atomic order mechanics, without assessment of taxes generated by these sales.

    For multi-period H20 cash/tax accounting use h20_continuous.run_h20_book.
    This helper cannot establish net profit or certify purchasing power after
    incremental taxes; it only honors liabilities already supplied in the book.
    """
    ...
    result = {"status": "SIMULATED_REBALANCE_NOT_PROFIT_EVIDENCE", "trades": trades,
              "incremental_sale_taxes_assessed": False,
