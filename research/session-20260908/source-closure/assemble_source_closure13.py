...
if 'duplicate_lineage' in snap:
    duplicates=rewrite(snap['duplicate_lineage'])
    (dest/'duplicate-lineage.json').write_text(json.dumps(duplicates,indent=2,ensure_ascii=False)+'\n',encoding='utf-8')
